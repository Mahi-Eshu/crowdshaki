        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:justify-between">
          <div className="mt-4">
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-col gap-5">
                  <span className="bg-black text-transparent w-[120px] bg-clip-text hover:bg-gradient-to-r hover:from-[#00c6ff] hover:to-[#0072ff] hover:cursor-pointer text-black text-xl font-regular hover:font-medium  transition-all">
                    Facebook
                  </span>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 lg:gap-20 lg:flex-row lg:mt-12">
            <div>
