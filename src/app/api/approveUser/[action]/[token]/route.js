...
const token = params.token
  try {
    ...
    await db.collection("users").updateOne({ token }, { $set: { status: newStatus } });
    ...
    const emailBody = `
      <html>
        <body>
          <p>Hello ${user.name},</p>
          <p>Your account has been ${newStatus}. If you have any questions, please reach out to our support team.</p>
